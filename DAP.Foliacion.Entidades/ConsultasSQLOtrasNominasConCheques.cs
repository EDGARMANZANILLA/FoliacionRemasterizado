    ...
    public class ConsultasSQLOtrasNominasConCheques
    {
        ...
        public string ObtenerConsultaConOrdenamientoFormasDePagoPensionAlimenticia(int Delegacion, string An)
        {
            ...
            switch (Delegacion)
            {
                ...
                case 7:
                    /*Hopelchen 7 */
                    cadenaConsulta = "select '' 'ID' , Substring(PARTIDA, 1, 6) 'PARTIDA',  num 'NUM'  , NOMBRE, DELEG, '' 'NOMINA' , NUM_CHE, LIQUIDO, '' 'CUENTABANCARIA' from interfaces.dbo.APAL2115000330 where TARJETA = '' and SERFIN = '' and BANCOMER = '' and BANORTE = '' and HSBC = '' and deleg = 07  order by JUZGADO, NOMBRE";
